...
.login-card { position: relative; z-index: 1; width: 100%; max-width: 420px; background: #ffffff; border-radius: 20px; border: 1px solid #dbeafe; box-shadow: 0 12px 40px rgba(37,99,235,0.09); padding: 44px 40px; display: flex; flex-direction: column; gap: 24px; }

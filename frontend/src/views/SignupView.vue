...
.login-card { position: relative; z-index: 1; width: 100%; max-width: 420px; background: #ffffff; border-radius: 20px; border: 1px solid #dbeafe; box-shadow: 0 12px 40px rgba(37,99,235,0.09); padding: 44px 40px; display: flex; flex-direction: column; gap: 20px; }
...
.field-input { width: 100%; box-sizing: border-box; background: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 10px; padding: 11px 12px; font-size: 14px; outline: none; transition: border-color 0.18s; }
...
.btn-primary { width: 100%; padding: 12px; background: #2563eb; border: none; color: #fff; font-weight: 600; cursor: pointer; border-radius: 10px; margin-top: 8px; transition: background 0.15s; }
